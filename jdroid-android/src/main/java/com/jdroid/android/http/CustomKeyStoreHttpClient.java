...
public abstract class CustomKeyStoreHttpClient extends DefaultHttpClient {
	...
	private SSLSocketFactory newSslSocketFactory() {
        try {
            ...
            InputStream in = getKeyStoreInputStream();
            try {
	...
	protected abstract InputStream getKeyStoreInputStream();
}
