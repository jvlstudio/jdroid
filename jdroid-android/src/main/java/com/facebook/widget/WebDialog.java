...
public class WebDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Now we know 'x' drawable width and height, layout the webivew and add it the contentFrameLayout layout
		 */
		 ...
		 */
		contentFrameLayout.addView(crossImageView, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
				ViewGroup.LayoutParams.WRAP_CONTENT));
		addContentView(contentFrameLayout, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
	...
	public static class FeedDialogBuilder extends BuilderBase<FeedDialogBuilder> {
		 ...
		 *            these parameters; it is the caller's responsibility to ensure they are valid.
		 * @param session the Session representing an authenticating user to use for showing the dialog; must not be
		 *            null, and must be opened.
		 */
		 ...
		 * profile that the story is being published from.
		 * 
