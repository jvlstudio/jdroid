...
/**
 * TV-specific implementation of the ActionBar API, using the title bar and a left navigation panel.
 */
public class LeftNavBar extends ActionBar {
	...
	/**
	 * Display option for the Left Navigation bar to automatically expand when certain ev ents happen. This includes
	 * gaining focus but could also include other events, such as mouse hover.
	 * 
	 * @see #setDisplayOptions(int)
	 * @see #setDisplayOptions(int, int)
	 */
	 ...
	 */
	public static final int DEFAULT_DISPLAY_OPTIONS = ActionBar.DISPLAY_SHOW_HOME | ActionBar.DISPLAY_USE_LOGO
			| ActionBar.DISPLAY_SHOW_TITLE | LeftNavBar.DISPLAY_ALWAYS_EXPANDED;
	...
	private void updateTitleBar(boolean animated) {
		...
		mTitleBar.setVisible(isShowing() && (titleVisible || progressVisible || horizontalProgressVisible), animated);
	...
	public int getHeight() {
		...
		return mLeftNav.getApparentWidth(true /*
											 * ignore the fact that it may be hidden
											 */);
	}
	...
	public void collapse() {
		mLeftNav.setExpanded(false);
	}
	
	public void expand() {
		mLeftNav.setExpanded(true);
	}
	
	public void flipOption(int option) {
		int options = getDisplayOptions();
		boolean hadOption = (options & option) != 0;
		setDisplayOptions(hadOption ? 0 : option, option);
	}
	...
	/**
	 * @see android.app.ActionBar#setIcon(android.graphics.drawable.Drawable)
	 */
	@Override
	...
	/**
	 * @see android.app.ActionBar#setLogo(int)
	 */
	@Override
	...
	/**
	 * @see android.app.ActionBar#setLogo(android.graphics.drawable.Drawable)
	 */
	@Override
