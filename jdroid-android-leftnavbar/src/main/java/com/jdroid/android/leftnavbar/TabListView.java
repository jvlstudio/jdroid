...
public class TabListView extends ListView {
	...
	public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
		...
		if (!hasFocus() && (selectedIndex >= 0) && (selectedIndex < getChildCount()) && (direction == FOCUS_LEFT)) {
	...
	/**
	 * Whenever the geometry of the list changes, focus gets cleared. This is problematic when the list gets expanded.
	 * Instead of letting the focus go away, it simply gets reset slightly later.
	 */
	@Override
